========================================================================
    Win32 アプリケーション: RTT4GamepadPlugin プロジェクトの概要
========================================================================

この RTT4GamepadPlugin アプリケーションは、AppWizard により作成されました。

このファイルには、RTT4GamepadPlugin 
アプリケーションを構成する各ファイルの内容の概要が含まれています。


RTT4GamepadPlugin.vcxproj
...
RTT4GamepadPlugin.vcxproj.filters
...
RTT4GamepadPlugin.ico
    これは、アプリケーションのアイコン (32x32) として使用されるアイコン 
    ファイルです。
    このアイコンは、メイン リソース ファイル RTT4GamepadPlugin.rc 
    にインクルードされます。

small.ico
    これは、アプリケーションのアイコンの小さいバージョン (16x16) を含むアイコン 
    ファイルです。 このアイコンは、メイン リソース ファイル RTT4GamepadPlugin.rc 
    にインクルードされます。
...
StdAfx.h、StdAfx.cpp
    これらのファイルは、RTT4GamepadPlugin.pch 
