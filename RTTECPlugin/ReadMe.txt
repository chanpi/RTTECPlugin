========================================================================
    Win32 アプリケーション: RTTECPlugin プロジェクトの概要
========================================================================

この RTTECPlugin アプリケーションは、AppWizard により作成されました。

このファイルには、RTTECPlugin 
...
RTTECPlugin.ico
    ...
    ファイルです。
    このアイコンは、メイン リソース ファイル RTTECPlugin.rc 
    にインクルードされます。

small.ico
    これは、アプリケーションのアイコンの小さいバージョン (16x16) を含むアイコン 
    ファイルです。 このアイコンは、メイン リソース ファイル RTTECPlugin.rc 
    にインクルードされます。
